...
[CustomEditor(typeof(ElectricDrill.SimpleRpgCore.Events.GameEventGenerator))]
public class GameEventGeneratorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        ElectricDrill.SimpleRpgCore.Events.GameEventGenerator generator =
            (ElectricDrill.SimpleRpgCore.Events.GameEventGenerator)target;
